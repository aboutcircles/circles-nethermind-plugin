...
public class CirclesRpcModule : ICirclesRpcModule
{
    ...
    public CirclesRpcModule(Context indexerContext)
    {
        ...
        _pluginLogger = new LoggerWithPrefix("Circles.Rpc:", baseLogger);
    ...
    private static AvatarRow?[] GetAvatarInfoBatch(Address[] addresses)
    {
        ...
        for (int i = 0; i < addresses.Length; i++)
        {
            ...
            bool hasV1 = Index.CirclesV1.LogParser.V1Avatars.TryGetValue(addressString, out var v1Avatar);
            bool hasV2 = Index.CirclesV2.LogParser.V2Avatars.TryGetValue(addressString, out var v2Avatar);
            ...
            bool hasV1Cid = Index.CirclesV1.NameRegistry.LogParser.V1AvatarToCidMap.TryGetValue(avatarAddress, out var v1Cid);
            bool hasV2Cid = Index.CirclesV2.NameRegistry.LogParser.V2AvatarToCidMap.TryGetValue(avatarAddress, out var v2Cid);
        ...
        int? version = null)
    {
        ...
        bool hasV2Avatar = Index.CirclesV2.LogParser.V2Avatars.TryGetValue(address2String, out var v2AvatarMeta);
    ...
    {
        var hasV1Balance =
            Index.CirclesV1.LogParser.BalancesByAccountAndToken.TryGetValue(address.ToString(true, false),
                out var v1Balances);
        ...
        var hasV2Balance =
            Index.CirclesV2.LogParser.BalancesByAccountAndToken.TryGetValue(address.ToString(true, false),
                out var v2Balances);
        ...
        {
            var isGroup = Index.CirclesV2.LogParser.Groups.ContainsKey(v2TokenBalance.Key);
            ...
            {
                // Demurraged Circles
                if (!Index.CirclesV2.LogParser.LastTokenMovement.TryGetValue(
    ...
    {
        var hasV2Profile = Index.CirclesV2.NameRegistry.LogParser.V2AvatarToCidMap.TryGetValue(address, out var v2Profile);
        if (hasV2Profile)
        {
            return ResultWrapper<string>.Success(v2Profile);
        }

        var hasV1Profile = Index.CirclesV1.NameRegistry.LogParser.V1AvatarToCidMap.TryGetValue(address, out var v1Profile);
        if (hasV1Profile)
        {
    ...
    public ResultWrapper<List<string?>> circles_getProfileCidBatch(Address[] addresses)
    {
        ...
        for (int i = 0; i < addresses.Length; i++)
        {
            ...
            var hasV2Profile =
                Index.CirclesV2.NameRegistry.LogParser.V2AvatarToCidMap.TryGetValue(address, out var v2Profile);
            if (hasV2Profile)
            {
                cids.Add(v2Profile);
                continue;
            ...
            var hasV1Profile =
                Index.CirclesV1.NameRegistry.LogParser.V1AvatarToCidMap.TryGetValue(address, out var v1Profile);
            if (hasV1Profile)
            {
                cids.Add(v1Profile);
                continue;
    ...
    {
        bool hasV1Cid = Index.CirclesV1.NameRegistry.LogParser.V1AvatarToCidMap.TryGetValue(avatar, out var v1Cid);
        bool hasV2Cid = Index.CirclesV2.NameRegistry.LogParser.V2AvatarToCidMap.TryGetValue(avatar, out var v2Cid);
        ...
        bool hasV2Avatar = Index.CirclesV2.LogParser.V2Avatars.TryGetValue(addressString, out var v2AvatarMeta);
        bool hasV1Avatar = Index.CirclesV1.LogParser.V1Avatars.TryGetValue(addressString, out var v1AvatarMeta);
        ...
        bool hasShortName =
            Index.CirclesV2.NameRegistry.LogParser.V2AvatarToShortNameMap.TryGetValue(avatar, out var shortName);
    ...
    public async Task<ResultWrapper<Profile?[]>> circles_getProfileByAddressBatch(Address?[] avatars)
    {
        ...
        for (int i = 0; i < avatars.Length; i++)
        {
            ...
            bool hasShortName =
                Index.CirclesV2.NameRegistry.LogParser.V2AvatarToShortNameMap.TryGetValue(avatarAddr, out var shortName);
    ...
    {
        var isV1 = Index.CirclesV1.LogParser.CirclesV1TokenOwnersByToken.TryGetValue(tokenAddress, out var v1TokenOwner);
        if (isV1)
        {
        ...
        var isV2_1155 = Index.CirclesV2.LogParser.V2Avatars.TryGetValue(tokenAddress.ToString(true, false), out var v2Avatar);
        if (isV2_1155)
        {
        ...
        var isV2_20 =
            Index.CirclesV2.LogParser.Erc20WrapperAddresses.TryGetValue(tokenAddress.ToString(true, false), out var v2Erc20);
        if (isV2_20)
        {
            bool isGroup = Index.CirclesV2.LogParser.Groups.ContainsKey(v2Erc20.TokenOwner);
