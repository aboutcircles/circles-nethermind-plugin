...
COPY src/Index/Circles.Index.CirclesV2.InvitationsAtScale/Circles.Index.CirclesV2.InvitationsAtScale.csproj ./Circles.Index.CirclesV2.InvitationsAtScale/
...
FROM nethermind/nethermind:1.35.7 AS base
