...
COPY --from=build /circles-nethermind-plugin/Circles.Index.CirclesV2.InvitationAtScale.dll ./artifacts/bin/Nethermind.Runner/debug/plugins/
COPY --from=build /circles-nethermind-plugin/Circles.Index.CirclesV2.InvitationAtScale.pdb ./artifacts/bin/Nethermind.Runner/debug/plugins/
...
COPY --from=build /circles-nethermind-plugin/Circles.Index.CirclesV2.PaymentGateway.dll ./artifacts/bin/Nethermind.Runner/debug/plugins/
COPY --from=build /circles-nethermind-plugin/Circles.Index.CirclesV2.PaymentGateway.pdb ./artifacts/bin/Nethermind.Runner/debug/plugins/
COPY --from=build /circles-nethermind-plugin/Circles.Index.CirclesV2.OIC.dll ./artifacts/bin/Nethermind.Runner/debug/plugins/
COPY --from=build /circles-nethermind-plugin/Circles.Index.CirclesV2.OIC.pdb ./artifacts/bin/Nethermind.Runner/debug/plugins/
