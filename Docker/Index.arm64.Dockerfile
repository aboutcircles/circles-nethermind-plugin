...
# TODO: remove once rpc has own module
...
RUN mkdir -p Rpc/Circles.Index.Rpc
COPY ./src/Rpc/Circles.Index.Rpc ./Rpc/Circles.Index.Rpc


# Build and publish
# RUN dotnet publish -c Release -o /circles-nethermind-plugin
RUN dotnet publish ./Circles.Index/Circles.Index.csproj -c Release -o /circles-nethermind-plugin
