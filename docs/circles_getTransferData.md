...
```
circles_getTransferData(address, direction?, counterparty?, fromBlock?, toBlock?, limit?, cursor?)
```
...
| 3   | `fromBlock`    | long?   | null     | Start block (inclusive)                         |
| 4   | `toBlock`      | long?   | null     | End block (inclusive)                           |
...
| `["0xA", null, null, 43000000, 44000000]`   | `(from=A OR to=A) AND block BETWEEN 43M..44M` |
| `["0xA", "sent", null, 43000000, 44000000]` | `from=A AND block BETWEEN 43M..44M`           |
...
curl -s -X POST https://staging.circlesubi.network \
  ...
  -d '{
    "jsonrpc": "2.0",
    "method": "circles_getTransferData",
    "params": ["0x227642eBD3a801E7b44A5bb956c02C2d97Ca71F0", null, null, 43000000, 44000000],
    "id": 1
  }'
```
...
curl -s -X POST https://staging.circlesubi.network \
  ...
  -d '{
    "jsonrpc": "2.0",
    "method": "circles_getTransferData",
    "params": ["0x227642eBD3a801E7b44A5bb956c02C2d97Ca71F0", "sent", null, 43000000, 44000000],
    "id": 1
  }'
```
